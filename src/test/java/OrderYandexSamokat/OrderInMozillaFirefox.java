...
public class OrderInMozillaFirefox {
    ...
    public OrderInMozillaFirefox(String name, String surname, String address, String metroStation, String phoneNumber, String orderDate, String rentalPeriod, String colour, String comment, String buttonType) {
        this.name = name;
