...
public class FAQYandexSamokatTestsGoogleChrome {
...
public FAQYandexSamokatTestsGoogleChrome(String questionId, String panelId, String expectedQuestion, String expectedAnswer) {
...
@Test
    ...
    String questionText = mainPage.getQuestionText(questionId); // проверить текст вопроса
    assertEquals(expectedQuestion, questionText); // проверка открытия соответствующего текста ответа
